...
<div class="card-body">
    <div class="row grid-margin"><div class="col-12">
        <button type="button" class="btn btn-primary ml-2" _msthash="812760" _msttexthash="176644">Nova Promoção</button>
    </div>
</div>
                            ...
                            <tbody>
                                <tr role="row" class="odd">
                                    ...
                                    <td _msthash="896987" _msttexthash="135057">Edimburgo</td>
                                     ...
                                     <td class="text-right">
                                        <button class="btn btn-light"><i class="mdi mdi-eye text-primary"></i><font _mstmutation="1" _msthash="1362530" _msttexthash="61152">Editar</font></button>
