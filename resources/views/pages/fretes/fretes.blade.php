...
<h4>Criação de Fretes</h4>

<div class="card-body">
    <div class="row grid-margin">
        <div class="col-12">
            <button type="button" class="btn btn-primary ml-2" _msthash="812760" _msttexthash="176644" data-toggle="modal" data-target="#novo_frete">Novo Frete</button>
                            ...
                            <tbody>
                                <tr role="row" class="odd">
                                    ...
                                    <td _msthash="896987" _msttexthash="135057">Edimburgo</td>
                                     ...
                                     <td class="text-right">
                                        <button type="button" class="btn btn-inverse-dark btn-sm ml-2" _msthash="812760" _msttexthash="176644" data-toggle="modal" data-target="#editar_frete">Editar</button>
                                        <button type="button" class="btn btn-inverse-danger btn-sm ml-2" _msthash="812760" _msttexthash="176644" data-toggle="modal" data-target="#excluir_frete">Excluir</button>
