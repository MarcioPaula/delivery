<div class="modal fade" id="cria_conexao" tabindex="-1" role="dialog" aria-labelledby="cria_conexaoLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="client-container">
                    <div class="client" style="display: none">
                        <img src="{{asset('img/imagem.gif')}}" id="qrcode" width="100%">
                        <br>
                    </div>
                </div>
